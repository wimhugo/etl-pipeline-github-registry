...
import { Menu, X, ChevronRight, ChevronLeft, LayoutDashboard, FolderOpen, Database, GitBranch, CheckSquare, FileText, Layers, RefreshCw, BookOpen, PenTool, Link2, FileEdit, Box, Eye, Settings2, Search, Pencil, Shuffle, BookMarked, Sliders, SlidersHorizontal, Workflow, BookKey, KeyRound, Code2, FileJson, DatabaseZap, Network } from 'lucide-react';
...
const ICON_MAP = {
  ...
  'Indexing Utility':     DatabaseZap,
  'Reasoner Update':       Network,
  'Settings':             Settings2,
  'Search':               Search,
  'Annotate':             Pencil,
  'Match':                Shuffle,
