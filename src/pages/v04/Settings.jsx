...
import RolePermissionsEditorV04 from '@/components/settings/RolePermissionsEditorV04';
...
export default function Settings() {
  ...
  const isPending = updateProjectMutation.isPending || updateGlobalMutation.isPending;
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">
            {activeProject ? `Project: ${activeProject.name}` : 'Settings'}
          </h1>
